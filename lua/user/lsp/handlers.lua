...
M.setup = function()
    ...
    local config = {
        ...
        virtual_text = true, -- could try turn on
        -- show signs
        signs = {
            active = signs,
        },
        ...
        underline = false,
        severity_sort = true,
        float = { -- could try change these options
            focusable = false,
            style = "minimal",
            border = "rounder",
            source = "always",
...
local function lsp_keymaps(bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>q", "<cmd>lua vim.lsp.buf.setloclist()<CR>", opts)
